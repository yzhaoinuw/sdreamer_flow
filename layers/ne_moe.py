...
from layers.attention import MultiHeadAttention, MultiHeadCrossAttention, MoEBlock_wNE, MultiHeadCrossAttention2
...
class MoELoader(nn.Module):
    def __init__(
        ...
        patch_mapper = {
            "time": PatchEncoder(patch_len, c_in, inner_dim) if feat_type != "NE" \
