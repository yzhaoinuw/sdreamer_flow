...
class Model(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.eeg_ep_encoder =  LSTM_EpochEncoder(patch_len, inner_dim,
                                    depth=e_layers, dropout=dropout,
                                    activation=activation)
        
        self.emg_ep_encoder =  LSTM_EpochEncoder(patch_len, inner_dim,
                                    depth=e_layers, dropout=dropout,
                                    activation=activation)
        
        self.seq_lstm =  LSTM_Encoder(inner_dim, depth=seq_layers, dropout=dropout,
                            activation=activation)
