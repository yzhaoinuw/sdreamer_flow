...
from layers.transformer import Transformer, MoETransformer, SeqNewMoETransformer, SeqNewMoETransformer2, NewMoETransformer
...
class Model(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.moe_transformer =  SeqNewMoETransformer2(
                                    patch_len, self.n_sequences, seq_layers, c_in, 
                                    inner_dim, n_heads = n_heads, d_head = d_head,
                                    dropout = dropout, path_drop = path_drop, 
                                    activation = activation, norm = norm_type, 
                                    mult = mult_ff, mix_type = args.mix_type, 
