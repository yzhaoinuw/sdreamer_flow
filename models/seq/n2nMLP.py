...
from layers.epochEncoder import MLP_EpochEncoder
...
class Model(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.eeg_ep_encoder =  MLP_EpochEncoder(seq_len, inner_dim,
                                    depth=e_layers, dropout=dropout,
                                    activation=activation)
        
        self.emg_ep_encoder =  MLP_EpochEncoder(seq_len, inner_dim,
                                    depth=e_layers, dropout=dropout,
                                    activation=activation)
        
        self.seq_transformer =  Transformer(
                                    patch_len, n_sequences, seq_layers, c_in, 
