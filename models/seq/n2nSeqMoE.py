...
from layers.transformer import Transformer, MoETransformer
...
class Model(nn.Module):
    ...
    def forward(self, x, label):
        ...
        x, eeg_feats, emg_feats = self.moe_transformer(cls_eeg, cls_emg)
        emb = torch.cat([eeg_feats, emg_feats], dim=-1)
