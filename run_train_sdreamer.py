...
config = dict(
    ...
    isNE=False,
    fold=1,
    root_path="C:/Users/yzhao/python_projects/time_series/sdreamer_input_data/",
    data_path="C:/Users/yzhao/python_projects/time_series/sdreamer_output_data/seq/",
    features="ALL",
    ...
    visualize_mode=[],
    visualizations="",
    checkpoints="C:/Users/yzhao/python_projects/time_series/sdreamer_checkpoints",
    reload_best=True,
    reload_ckpt=None,
    use_gpu=True,
    gpu=0,
