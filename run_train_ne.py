...
ca_layers = 1
batch_size = 64
n_sequences = 64  # epochs per sequence; Jaysen found 64 > 256/512
ne_patch_len = 10
e_layers = 2
fold = 1
...
config = dict(
    ...
    scheduler="CosineLR",
    scale=0.0,
    ne_mix_ratio=0.5,  # fraction of each batch with NE zeroed (Jaysen's "mixed_50" training)
    pct_start=0.3,
    step_size=30,
    gamma=0.5,
    weight=[1, 1, 1],
...
if __name__ == "__main__":
    # specify the paths
    data_path = "../sdreamer_data_ne/"  # where write_training_data_ne.py saved the NE tensors
    checkpoints = "../sdreamer_checkpoints/"  # model save directory
    des_name = "ne_mixed_50"  # suffix in the model name
