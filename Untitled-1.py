...
useNorm = True
train_traces = torch.from_numpy(
    np.load("{}train_trace{}.npy".format(dst_path, fold), allow_pickle=True)
)
train_labels = torch.from_numpy(
    np.load("{}train_label{}.npy".format(dst_path, fold), allow_pickle=True)
)
val_traces = torch.from_numpy(
    np.load("{}val_trace{}.npy".format(dst_path, fold), allow_pickle=True)
)
val_labels = torch.from_numpy(
    np.load("{}val_label{}.npy".format(dst_path, fold), allow_pickle=True)
)
