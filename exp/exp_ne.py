...
MixTransformer, MacrossTransformer, MoETransformer, FreqTransformer, BaseLineNE, CMTransformer, TFTransformer, TFCMTransformer, SMoETransformer, \
SimMoE, FreqCM, MLP_base, SWBaseLine, LSTM_base
from models.seq import n2nViTTransformer, n2nCMATransformer, n2nMacrossTransformer,n2nMoETransformer, \
n2nBaseLineNE, n2nSeqCM, n2nCMTransformer,n2nSeqMoE, n2nMLP, n2nLSTM
...
class Exp_Main(object):
    ...
    def train(self, train_loader, model, criterion, optimizer, scheduler, \
              epoch, device, args):
    ...
    def run_train(self, setting):
        ...
        for epoch in range(self.args.epochs):
            ...
            self.train(train_loader, self.model, criterion, optimizer, scheduler, epoch, self.device, self.args)
            print("\n")
