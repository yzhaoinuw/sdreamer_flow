...
n2nBaseLine, n2nSeqCM, n2nCMTransformer,n2nSeqMoE, n2nSeqNewMoE, n2nSeqNewMoE2
...
class Exp_MoE(object):
    ...
    def eval(self,val_loader, model, criterion, criterion2, criterion3, args):
        Time, Loss, Acc, F1, Kappa, Precision, Recall, \
            w_f1, s_f1, r_f1, w_prec, s_prec, r_prec, w_rec, s_rec, r_rec = build_tracker(isEval=True)
        ...
        with torch.no_grad():
            ...
            for i, (traces, labels) in enumerate(val_loader):
                ...
                loss = loss1 + distill_eeg + distill_emg
